...
import 'package:stockcalculator/pages/price_result_page.dart';
...
class CalculatePricePage extends StatefulWidget {
  @override
  _CalculatePricePageState createState() => _CalculatePricePageState();
}

class _CalculatePricePageState extends State<CalculatePricePage> {
  ...
  void initState() {
    ...
    if (FavouriteHelper().getTarget() == FavouriteTarget.Price) {
              ...
              FloatingActionButton(
                ...
                onPressed: () {
                  if (_formKey.currentState.validate()) {
                    ...
                    PriceResult price = CalculateHelper.calculatePrice(
                    ...
                    Navigator.push(
                      ...
                      new MaterialPageRoute(
                        builder: (context) => PriceResultPage(
                          priceResult: price,
                        ),
                      ),
                    );
  ...
  void _updateFavouriteData() {
    ...
    Favourite newFavourite = new Favourite(
      ...
      sellingPrice: _currentFavourite.sellingPrice,
